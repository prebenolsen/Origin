# Visiting Spain — Words Taught (English)

Module 1. This is the first module, so the list contains only words introduced here.
...
# Meeting People — Words Taught (English)

Module 2. Because it builds on earlier modules, the words are split into two lists:
words carried over from previous modules, and words introduced here.

---

## Words from previous modules

From **Visiting Spain** (Module 1) — 126 entries.
...
# Unlock Spanish — Words Taught (English)

Module 3 (the grammar bridge). It mostly recombines words already known, so the few new
entries are structural. Split into words carried over and words introduced here.

---

## Words from previous modules

From **Visiting Spain** (Module 1) — 126 entries — and **Meeting People** (Module 2) — 66
entries. See those module sections above for the full lists; every noun used by this module's
sentence drills (the coffee, the table, the bread, the food, the family, the toilet, the
restrooms) was taught there.
...
### Connect Your Thoughts (connectors)
- and
- but
- because
- also / too
...
### I Do, You Do, They Do (present tense)
- I
- you (informal)
- he
- she
